        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            ...
            <div v-if="viewMode === 'list'" class="space-y-2">
                <Card 
                    ...
                    @click="file.type === 'folder' ? openFolder(file.id) : toggleSelection(file.id)"
            ...
            <Dialog v-model:open="isImagePreviewOpen">
                <DialogContent class="max-w-4xl max-h-[90vh] p-0">
                    ...
                    <div class="p-6 pt-4">
                        <div class="flex justify-center items-center bg-slate-50 dark:bg-slate-900 rounded-lg overflow-hidden min-h-[400px]">
                            <img 
